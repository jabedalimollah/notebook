        ...
        <div className="w-4/12 background_gradient_color p-8 flex flex-col justify-center items-center rounded-lg shadow-2xl gap-y-2">
          ...
          <div className="w-full flex justify-center gap-x-4">
            <button
              ...
              className="bg-gray-300 py-1 px-3 rounded shadow-md  shadow-gray-400 hover:bg-blue-400 hover:text-white hover:shadow-none"
            >
              Cancel
            </button>
            <button
              onClick={handleDeleteData}
              className="bg-red-600 text-white py-1 px-3 rounded shadow-md shadow-red-400 hover:bg-red-700 hover:shadow-none"
            >
              Delete
            </button>
          </div>
